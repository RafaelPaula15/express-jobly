...
//method used on the routes folder 
...
//find companies with minimun employees
  static async minEmployees(num) {
    ...
    if (!company) throw new NotFoundError(`No company:${company}`);

    return company;
  }


  //find companies with maximun employees
